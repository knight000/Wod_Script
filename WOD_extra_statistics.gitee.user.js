...
// @require      https://gitee.com/kni_gitee/static/raw/master/js/jquery.min.js
// @require      https://gitee.com/kni_gitee/static/raw/master/js/Blob.js
// @require      https://gitee.com/kni_gitee/static/raw/master/js/FileSaver.js
// @require      https://gitee.com/kni_gitee/static/raw/master/js/jszip.js
// @require      https://gitee.com/kni_gitee/static/raw/master/js/jquery.form.js
// @downloadURL  https://gitee.com/kni_gitee/static/raw/master/user_script/WOD_extra_statistics.user.js
// @updateURL    https://gitee.com/kni_gitee/static/raw/master/user_script/WOD_extra_statistics.user.js
// ==/UserScript==
(function () {
    // COMMON FUNCTIONS ///////////////////////////////////////////////////////////
        ...
        for (var i = 0; i < allCheckbox.length; ++i) {
            ...
            if (rValue.Pattern_checkboxName.test(theCheckbox.getAttribute("name"))) {
                if (theCheckbox.checked) {
                    ...
                    default_gTitle = prefix + theCheckbox.getAttribute("reportname").replace(/<[^>]+>/g, '').replace(/[ ]|[\r\n\t]/g, "");
    ...
    function ReadDuelPage() {
        ...
        handleIndexPage();
        infodiv.innerHTML = "保存决斗战报：&nbsp;" + gTitle + "<br/>" + gCurrentReport.getAttribute("title");
        var indexStr = '<html>\n' + headDiv.outerHTML + '\n<body>\n<h1>' + gTitle + '</h1><br/>\n' + gIndexDiv.innerHTML + '\n</body>\n</html>';
    ...
    function ReprotMain() {
        ...
        for (i = 0; i < allH1.length; ++i) {
            ...
            if (h1.innerHTML == rLocal.OrigText_H1_DungeonLog || h1.innerHTML == rLocal.OrigText_H1_DuelLog) {
                ...
                // 默认使用团队名作为前缀
                prefixBox.setAttribute("value", "[" + document.getElementsByName("gruppe_name")[0].value + "]")
                prefixBox.innerHTML = "[" + document.getElementsByName("gruppe_name")[0].value + "]"
                h1.parentNode.insertBefore(prefixBox, h1.nextSibling);
                var newSpan = document.createElement("span");
                newSpan.innerHTML = "战报导出命名前缀:";
                h1.parentNode.insertBefore(newSpan, h1.nextSibling);
